...
Schedule::command('api:sync')->twiceDaily(6, 18);

Schedule::command('replicate:orders')->twiceDaily(7, 19);
Schedule::command('replicate:sales')->twiceDaily(7, 19);
Schedule::command('replicate:incomes')->twiceDaily(7, 19);
Schedule::command('replicate:stocks')->twiceDaily(7, 19);
